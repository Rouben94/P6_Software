...
/* ================= Zigbee Stuff ====================== */
#define DEFFERED_LOGGING true                        /* Activate Deffered logging. Log data is buffered and can be processed in idle via NRF_LOG_PROCESS() or flushed via NRF_LOG_FLUSH(). If set false logs will be written directly but performance is decreased */
